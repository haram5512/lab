...
from .proposed_rgb_shape_v3 import CannyEdge, LaplacianEdge, ProposedRGBShapeV3, ProposedV3Config
...
__all__ = [
    ...
    "ProposedRGBShapeV3", "ProposedV3Config", "CannyEdge", "LaplacianEdge",
]
